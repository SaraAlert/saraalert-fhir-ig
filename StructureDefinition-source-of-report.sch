...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'source-of-report']) &gt;= 1">extension with URL = 'source-of-report': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'source-of-report']) &lt;= 1">extension with URL = 'source-of-report': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'specify']) &lt;= 1">extension with URL = 'specify': maximum cardinality of 'extension' is 1</sch:assert>
