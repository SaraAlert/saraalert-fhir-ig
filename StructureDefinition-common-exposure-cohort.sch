...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'cohort-type']) &lt;= 1">extension with URL = 'cohort-type': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'cohort-name']) &lt;= 1">extension with URL = 'cohort-name': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'cohort-location']) &lt;= 1">extension with URL = 'cohort-location': maximum cardinality of 'extension' is 1</sch:assert>
