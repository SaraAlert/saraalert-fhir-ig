...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:QuestionnaireResponse">
      ...
      <sch:assert test="count(f:extension[@url = 'http://saraalert.org/StructureDefinition/who-reported']) &lt;= 1">extension with URL = 'http://saraalert.org/StructureDefinition/who-reported': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://saraalert.org/StructureDefinition/symptomatic']) &lt;= 1">extension with URL = 'http://saraalert.org/StructureDefinition/symptomatic': maximum cardinality of 'extension' is 1</sch:assert>
